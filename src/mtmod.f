...
! added by JS for debugging:
      integer, SAVE :: ncycle = 0
      integer*4, SAVE :: mtmod_ngen = 0

! the array for the state vector
      integer, save, dimension(0:N-1) :: mt
      integer, save                   :: mti = N1
      integer, save                   :: mt_seed = defaultsd
...
!                        mag01(x) = x * MATA for x=0,1
      ...
      if(mti.ge.N) then
       ...
       ! if ((ncycle>=1.and.(ncycle<=1).and.mti<10) write(*,*) 'mtmod: mti, mt(0)=',mti,mt(0)
...
!                              a default initial seed is used
      ...
      !if (ncycle==2.and.mti<10) write(*,*) 'mtmod: mti, mt(0), grnd = ',mti,mt(0), grnd
      mtmod_ngen = mtmod_ngen+1
